...
dati=['dati/DATI_GABRIELE.txt','dati/diodo.txt','dati/diodo4.txt','dati/losifra4diodo.txt','dati/suca.txt']

Volt=np.loadtxt(dati[1], unpack='true')
...
for i in range(0,2*a):
	...
	y=Sega(x,1,T_i,T_i/n,taglio_i,risoluzione)
	ax.plot(x,y)
