...
interleaved. Vengono eseguite in successione 8 acquisizioni con un ritardo variabile
...
int delint=5; // variabile di ritardo interleaved in us (default 10 us)
...
void loop()
  ...
  if(!start) return // Se il flag e' start=0 non esegue le operazioni qui di seguito
    ...
    for(i=0;i<1;i++) // Loop di una misura a vuoto per "scaricare" A0
      {
