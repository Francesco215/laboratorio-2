...
# L'operazione puoâ€™ essere ripetuta in loop
...
Directory=â€˜../dati_arduino/â€˜   # nome directory dati
                                                    # << DA CAMBIARE SECONDO NECESSITA'

FileName=Directory+â€™dataXX.txt'  # parte comune nome file << DA CAMBIARE SECONDO NECESSITA'
...
for j in range (1,nacqs+1):
    ...
    ard=serial.Serial(â€˜/dev/ttyACM0â€™,19200)  # apre porta seriale (occhio alla sintassi, dipende
    ...
    ard.write(b'5') # scrive il carattere per l'intervallo di campionamento
                    # in unitaâ€™ di 100 us << DA CAMBIARE A SECONDA DEI GUSTI
                    # l'istruzione b indica che eâ€™ un byte (carattere ASCII)
